...
# Flask-User settings
    ...
    USER_SEND_PASSWORD_CHANGED_EMAIL = True  # Disable email password change
    USER_REQUIRE_RETYPE_PASSWORD = True
    USER_ENABLE_CHANGE_USERNAME = False
    USER_AUTO_LOGIN_AFTER_REGISTER = True
    USER_AUTO_LOGIN_AT_LOGIN = True
    CSRF_ENABLED = True
    USER_APP_NAME = 'StockEase'
    ...
    # Flask-User mail SMTP server setting (these can stay or be removed)
